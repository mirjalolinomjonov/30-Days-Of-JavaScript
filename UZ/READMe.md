...
- [📔 Day 1](#-day-1)
  ...
  - [Sozlash](#setup)
    - [Node.js ni oʻrnating](#install-nodejs)
    - [Brauzer](#browser)
      - [Google Chrome o'rnatish](#installing-google-chrome)
      - [Google Chrome da konsolni ochish](#opening-google-chrome-console)
      - [Brauzer konsolida kod yozish](#writing-code-on-browser-console)
        - [Console.log bilan ishlash](#consolelog)
        - [Bir nechta argumentli Console.log](#consolelog-with-multiple-arguments)
        - [Izohlar](#comments)
        - [Sintaksis](#syntax)
      - [Arifmetik amallar](#arithmetics)
    - [Kod muharrirlari](#code-editor)
      - [Visual Studio Code ni oʻrnatish](#installing-visual-studio-code)
      - [Visual Studio Code dan qanday foydalanish kerak](#how-to-use-visual-studio-code)
  - [Veb-sahifaga JavaScript qo'shish](#adding-javascript-to-a-web-page)
  ...
  - [Ma'lumotlar turlari haqida](#introduction-to-data-types)
    - [Numbers (Sonlar)](#numbers)
    - [Strings (Satrlar)](#strings)
    - [Booleans (Mantiqiy)](#booleans)
    - [Undefined (Aniqlanmagan)](#undefined)
    - [Null (Bo'sh)](#null)
  - [Ma'lumotlar turlarini tekshirish](#checking-data-types)
  - [Yana izohlar](#comments-again)
  - [O'zgaruvchilar](#variables)
- [💻 1-kun: Mashqlar](#-day-1-exercises)
